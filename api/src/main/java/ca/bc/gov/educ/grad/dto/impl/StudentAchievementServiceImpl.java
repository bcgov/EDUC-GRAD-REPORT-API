...
public class StudentAchievementServiceImpl implements StudentAchievementService, Serializable {
    ...
    public Achievement getAchievementInformation(final String pen) throws DomainServiceException {
        ...
        try {
            ...
            achievement = gradtoIsdDataConvertionBean.getAchievement(reportData);

            final List<AchievementCourse> courses = gradtoIsdDataConvertionBean.getAchievementCources(reportData);
    ...
    private StudentInfo getStudentInfo(final String pen) throws DataException, DomainServiceException {
        ...
        try {
            ...
            StudentInfoImpl student = (StudentInfoImpl) gradtoIsdDataConvertionBean.getStudentInfo(reportData);
            final HashMap<String, String> reasons = gradtoIsdDataConvertionBean.getNongradReasons(reportData);
    ...
    private StudentDemographic getStudentDemog(final String pen) throws DataException, DomainServiceException {
        ...
        try {
            studentDemographic = gradtoIsdDataConvertionBean.getSingleStudentDemog(reportData);
    ...
    private List<AchievementCourse> getAchievementCourseList(
        ...
        try {
            ...
            results = gradtoIsdDataConvertionBean.getAchievementCources(reportData);
    ...
    private List<AssessmentResult> getAssessmentResultList(
        ...
        try {
            ...
            List<NumAssessmentResult> resultsList = gradtoIsdDataConvertionBean.getAssessmentCourses(reportData);
    ...
    private synchronized StudentAchievementReport createReport(
        ...
        try {
            ca.bc.gov.educ.grad.dto.reports.data.impl.Student stu = (ca.bc.gov.educ.grad.dto.reports.data.impl.Student)report.getDataSource();
