...
import ca.bc.gov.educ.grad.report.dto.impl.AchievementResultImpl;
...
public class AchievementResultListDeserializer extends StdDeserializer<List<AchievementResult>> {

    protected AchievementResultListDeserializer() {
        this(null);
    }

    protected AchievementResultListDeserializer(Class<?> vc) {
        super(vc);
    }

    @Override
    public List<AchievementResult> deserialize(JsonParser jsonParser, DeserializationContext deserializationContext) throws IOException, JsonProcessingException {
        ...
        for (; elements.hasNext();) {
            ...
            AchievementResultImpl r = new AchievementResultImpl();
            r.setCourse(course);
            r.setMark(mark);
