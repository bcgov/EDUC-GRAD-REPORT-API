...
import ca.bc.gov.educ.grad.report.dto.reports.data.impl.DistrictOrganisation;
import ca.bc.gov.educ.grad.report.dto.reports.data.impl.School;
...
import ca.bc.gov.educ.grad.report.model.reports.StudentReport;
...
public abstract class StudentReportImpl extends ReportImpl implements StudentReport {
     ...
     */
    @Override
    public void setStudent(final ca.bc.gov.educ.grad.report.model.student.Student student) {
     ...
     */
    @Override
    public void setSchool(final ca.bc.gov.educ.grad.report.model.school.School school) {
