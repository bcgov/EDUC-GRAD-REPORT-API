...
import static ca.bc.gov.educ.grad.model.common.Constants.*;
...
public class ServiceConstants {
    ...
    public final static String REPORT_SERVICE
            = JNDI_GLOBAL + REPORT_SERVICES_APP_NAME + "/" + REPORT_SERVICES_MODULE_NAME + "/ReportServiceImpl!ca.bc.gov.educ.grad.model.reports.ReportService";

    public final static String BCMP_SERVICE
            = JNDI_GLOBAL + REPORT_SERVICES_APP_NAME + "/" + BCMP_SERVICES_MODULE_NAME + "/BCMPBundleServiceImpl!ca.bc.gov.educ.grad.dto.reports.bundle.service.BCMPBundleService";

    /**
     * For objects that must have values set (predominately receipt report).
     */
    public final static String REPORT_ADMIN_SERVICE
            = JNDI_GLOBAL + REPORT_SERVICES_APP_NAME + "/" + REPORT_SERVICES_MODULE_NAME + "/ReportAdminServiceImpl!ca.bc.gov.educ.grad.dto.reports.ReportAdminService";

    /**
     * For administrative reports.
     */
    public final static String ADMIN_REPORT_SERVICE
            = JNDI_GLOBAL + REPORT_SERVICES_APP_NAME + "/" + REPORT_SERVICES_MODULE_NAME + "/AdminReportServiceImpl!ca.bc.gov.educ.grad.dto.reports.admin.AdminReportService";

    public final static String CODESET_ADMIN_SERVICE
            = JNDI_GLOBAL + CODESET_SERVICES_MODULE_NAME + "/CodeSetAdminEntityBean!ca.bc.gov.educ.grad.model.codes.CodeSetAdminEntityService";

    public final static String CODESET_SERVICE
            = JNDI_GLOBAL + CODESET_SERVICES_MODULE_NAME + "/CodeSetEntityBean!ca.bc.gov.educ.grad.model.codes.CodeSetEntityService";

    public final static String CODE_ADMIN_SERVICE
            = JNDI_GLOBAL + CODESET_SERVICES_MODULE_NAME + "/CodeAdminEntityBean!ca.bc.gov.educ.grad.model.codes.CodeAdminEntityService";
    ...
    public final static String STUDENT_X_REF_SERVICE
            = JNDI_GLOBAL + STUDENT_DEMOG_SERVICES_MODULE_NAME + "/StudentXRefEntityService!ca.bc.gov.educ.grad.model.student.StudentXRefService";

    public final static String STUDENT_X_REF_ADMIN_SERVICE
            = JNDI_GLOBAL + STUDENT_DEMOG_SERVICES_MODULE_NAME + "/StudentXRefEntityAdminService!ca.bc.gov.educ.grad.model.student.StudentXRefAdminService";
    ...
    public final static String STUDENT_EXAM_SERVICE
            = JNDI_GLOBAL + TRANSCRIPT_SERVICES_MODULE_NAME + "/StudentExamServiceImpl!ca.bc.gov.educ.grad.model.exam.StudentExamService";

    public final static String NUMERACY_ASSESSMENT_SERVICE
            = JNDI_GLOBAL + TRANSCRIPT_SERVICES_MODULE_NAME + "/NumeracyAssessmentServiceImpl!ca.bc.gov.educ.grad.model.assessment.NumeracyAssessmentService";

    public final static String LITERACY_ASSESSMENT_SERVICE
            = JNDI_GLOBAL + TRANSCRIPT_SERVICES_MODULE_NAME + "/LiteracyAssessmentServiceImpl!ca.bc.gov.educ.grad.model.assessment.LiteracyAssessmentService";

    public final static String STUDENT_TRANSCRIPT_SERVICE
            = JNDI_GLOBAL + TRANSCRIPT_SERVICES_MODULE_NAME + "/StudentTranscriptServiceImpl!ca.bc.gov.educ.grad.model.transcript.StudentTranscriptService";
    ...
    public final static String EVENT_SERVICE
            = JNDI_GLOBAL + EVENT_SERVICES_MODULE_NAME + "/EventBroadcastSupportImpl!ca.bc.gov.educ.grad.model.common.EventBroadcastSupport";
