...
import ca.bc.gov.educ.grad.model.reports.AchievementReport;
...
public class AchievementReportImpl extends StudentReportImpl implements AchievementReport {
    ...
    public void setGraduationData(final GraduationData graduationData) {
        final ca.bc.gov.educ.grad.dto.reports.data.impl.AcademicAward aa
     ...
     */
    @Override
    public void setAchievement(final ca.bc.gov.educ.grad.model.achievement.Achievement achievement) {
