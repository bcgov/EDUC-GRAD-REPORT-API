...
public abstract class StudentReportImpl extends ReportImpl implements StudentReport {
     ...
     */
    @Override
    public void setStudent(final ca.bc.gov.educ.grad.model.student.Student student) {
     ...
     */
    @Override
    public void setSchool(final ca.bc.gov.educ.grad.model.school.School school) {
