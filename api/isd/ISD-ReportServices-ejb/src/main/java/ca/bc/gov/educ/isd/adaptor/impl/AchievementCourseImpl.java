 ...
 * ***********************************************************************
 */
package ca.bc.gov.educ.isd.adaptor.impl;

import ca.bc.gov.educ.isd.adaptor.dao.impl.CourseId;
...
public class AchievementCourseImpl implements AchievementCourse {
     ...
     */
    public AchievementCourseImpl(final TranCourseEntity transcript) {
     ...
     */
    public AchievementCourseImpl(final CourseId pk, final TranCourseEntity transcript) {
        this(
                pk.getStudNo(),
